...
sum: Material didáctico manipulativo para educación. Modelos 3D mediante impresión de materiales reponibles adaptados a todos los estudiantes.
seo:
...
org:
  ...
  - /u/base/poster.svg
  - /u/nosotros.jpg
  - /u/estudiantes-docentes.jpg
  - /u/material-didactico.jpg
  as:
...
sections:
  ...
  caracteristicas:
    ...
    - icon: chess
      title: Diseño
      md: Cada modelo es cuidadosamente diseñado para garantizar precisión y facilidad de uso
    - icon: precision_manufacturing
      title: Tecnología Avanzada
      md: Utilizamos impresión 3D para crear recursos educativos innovadores y accesibles
    - icon: recycling
      title: Sostenible
      md: Utilizamos materiales biodegradables en la fabricación para respetar el medio ambiente
    - icon: extension
      title: Piezas Recambiables
      md: Existe la posibilidad de adquirir piezas sueltas para no perder la inversión inicial
    - icon: settings
  ...
  contacto:
    ...
    icon: send
    md: O haznos preguntas sobre nuestros materiales
    links:
    - type: mail
