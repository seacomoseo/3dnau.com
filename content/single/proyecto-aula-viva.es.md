...
landing_sections:
  header:
    ...
    label: ¡Quiero el dossier gratis!
    url: '#descarga'
  pain:
    title: La realidad de un aula en silencio...
    ...
    md: |-
      ...
      Es frustrante pasar horas preparando apuntes para acabar sintiendo que eres un mero dictador de libros de texto. **Pierdes tardes enteras buscando recursos por internet** sin saber si finalmente te servirán en el laboratorio.

      El sistema te está empujando a ser el tipo de profesor gris que tú mismo odiabas. **Y tú no te hiciste científico para esto**.
  solution:
  ...
  qualification:
    title: Buscamos docentes que quieran dejar huella
  ...
  resenas:
    ...
    sub: Lo dicen los docentes que ya están transformando sus aulas
    icon: chat
    reviews:
